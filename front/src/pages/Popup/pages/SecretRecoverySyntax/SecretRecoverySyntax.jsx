    ...
    return (
        <div className="ProtectWallet">
            ...
            <div>
                ...
                <div className="syntax-box">remain outside liberty sweet wait addict lottery music battle nerve ugly lion</div>

            </div>

            <div className="protect-wallet-next-btn-box">
                <button className="protect-wallet-next-btn" onClick={() => {
                    setPage("MyWallet");
                }}>완료</button>
            </div>
